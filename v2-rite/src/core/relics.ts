...
export const RELICS: Record<RelicId, RelicDef> = {
  ...
  pilgrimSandals: {
    id: 'pilgrimSandals',
    name: 'Сандалии пилигрима',
    effect: 'Послушники ходят на 2. Стражи ходят на 1–4. Атака не меняется.',
  },
  ...
  ashenCrown: { id: 'ashenCrown', name: 'Пепельный венец', effect: 'В каждом бою одна случайная мелкая тварь не появляется' },
...
/** Дальность движения Послушника (Сандалии пилигрима: 2, атака не меняется). */
